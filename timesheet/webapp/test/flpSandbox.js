		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Timesheet",
									"targetURL": "#comibspltimesheet-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibspltimesheet-display": {
								"semanticObject": "comibspltimesheet",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibspl.timesheet",
									"url": sap.ui.require.toUrl("com/ibspl/timesheet")
								}
							}
						}
					}
