		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "demo",
									"targetURL": "#comibspltwoservice-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibspltwoservice-display": {
								"semanticObject": "comibspltwoservice",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibspl.twoservice",
									"url": sap.ui.require.toUrl("com/ibspl/twoservice")
								}
							}
						}
					}
